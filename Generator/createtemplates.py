...
def render_template(template_filename, context):
    ...
    print(os.path.join(path, '..', constants.targetDestination + "app\\templates\\app\\"))

    template_environment = Environment(
        autoescape=False,
        loader=FileSystemLoader(os.path.join(path, '..', constants.targetDestination + "app\\templates\\app\\")),
        trim_blocks=False)
